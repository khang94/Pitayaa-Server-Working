...
public class ObjectHibernateListener extends ObjectHibernateListenerHelper{
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ObjectHibernateListener.class);
